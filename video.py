...
'''
    ...
    print("src_dlatents",src_dlatents.shape)
    print("dst_dlatents",dst_dlatents.shape)

    # src_dlatents (1200, 14, 512)
    # dst_dlatents (1, 14, 512)
    ...
    def make_frame(t):
        ...
        print("col_dlatents",col_dlatents.shape)
        col_images = Gs.components.synthesis.run(col_dlatents, randomize_noise=False, **synthesis_kwargs)
        print("col_images",col_images.shape)
        return col_images[0]
